      ...
      <div className="container mx-auto">
        <div className="bg-white p-6 md:p-12 rounded-lg shadow-lg md:flex md:items-start">
          ...
          <div className="md:w-1/2 mb-6 md:mb-0 p-6">
            ...
            <h2 className="text-3xl font-bold mb-2">Connect with FarmTech</h2>
            <p className="text-gray-600 mb-4">Your Partner in Agri-Innovation</p>
            <p className="text-gray-600 mb-6">At the crossroads of tradition and innovation, FarmTech is cultivating a future where land meets its full potential. We bridge the gap between Canadian landowners and dynamic farmers, offering a suite of services that propel productivity and sustainability.
